...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_0),    KC_W,           KC_F,           KC_P,           KC_G,           KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_2),    KC_L,           KC_U,           KC_Y,           KC_QUOTE,       KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_Z,           RALT_T(KC_X),   KC_C,           TD(DANCE_1),    KC_B,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, TD(DANCE_3),    LT(8,KC_M),     KC_COMMA,       LALT_T(KC_DOT), KC_SLASH,       KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(6,KC_DELETE),LT(4,KC_BSPACE),LT(5,KC_ENTER),                                 LT(2,KC_TAB),   LT(1,KC_SPACE), LT(3,KC_ESCAPE),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_PGUP,        KC_HOME,        KC_UP,          KC_END,         KC_INSERT,      KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          WEBUSB_PAIR,    RESET,          KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_PC_UNDO,     KC_PC_CUT,      KC_PC_COPY,     KC_PC_PASTE,    LCTL(KC_Y),     KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_NO,          ST_MACRO_0,     KC_NO,          KC_RALT,        KC_NO,          KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_MS_WH_UP,    KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          WEBUSB_PAIR,    RESET,          KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_LSHIFT,      KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, LALT(KC_6),     LALT(KC_7),     LALT(KC_8),     LALT(KC_9),     LALT(KC_0),     KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LALT(KC_1),     LALT(KC_2),     LALT(KC_3),     LALT(KC_4),     LALT(KC_5),     KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_LSHIFT,      KC_LCTRL,       KC_LALT,        KC_LGUI,        KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [3] = { {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255}, {250,63,255} },

    [4] = { {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139}, {172,255,139} },

    [5] = { {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205}, {86,192,205} },
